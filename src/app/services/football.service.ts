...
import { Results } from '../components/interfaces/results';
...
export class FootballService {
  ...
  getStandingsForCurrentSeason(year:number, idLeague:number){
   ...
   // return this.httpClient.get<Results>(this.standings)
    ...
    return this.httpClient.get<Results>(environment.api + '/standings' , {headers: this.headers, params: params} ) 

  }

  getFixitureForTeam(team:number, season:number, league:number, last:number){
  ...
  //  return this.httpClient.get<Results>(this.fixitures)
    ...
    return this.httpClient.get<Results>(environment.api + '/fixtures' , {headers: this.headers, params: params} ) 
  ...
  getTeamInformation(team:number) {
   // return this.httpClient.get<Results>(this.team)
    ...
    return this.httpClient.get<Results>(environment.api + '/teams' , {headers: this.headers, params: params} ) 
  }
